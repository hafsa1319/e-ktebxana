                  ...
                  <div class="Account">\
                     <div class="Left">\
                        ...
                        <div class="NavList">\
                           ...
                           <a href="/my-avatar" class="Btn Active"> \
               ...
               <div class="col-12 ">\
                  <div class="BackgroundArea">\
                     <div class="BackgroundBox">\
                        <div class="TabArea">\
                           <a href="/my-account" class="Tab"> '+pageLang(1988)+' </a>\
                           <a href="/my-avatar" class="Tab Active"> '+pageLang(1989)+' </a>\
                           <a href="/my-background" class="Tab "> '+pageLang(1990)+' </a>\
                        </div>\
                        <div class="View">\
                           ...
                           <div class="Arrow Next fa fa-arrow-right"></div>\
                        </div>\
                     </div>\
                  </div>\
               </div>\
      ...
      if(WW<980){
         $(".Header .Left").html("<a href='/student-library' class='BtnBookList'><i></i> <span> "+pageLang(2455)+" </span></a>")
      }
      ...
      success: function(data) {
         $.each(data, function( i, itemx ) {
            ...
            var data       =  itemx.file
               ...
               ')
               if(data==systemUser.user.avatar){ $(".BackgrounContent>div[data-id='"+data_ID+"']").addClass("Selected") }
         });
         ...
         $(".BackgrounContent>div").click(function(){
            ...
            $(".Header .Right .User>.Profil>.Photo").css({"background-image":"url("+File+")"})

            $.ajax({
            type: "post",
            url: systemApp+"user/avatar/",
            dataType: "json",
            data : "id="+systemUser.user.id+"&avatar="+File+"",
            success: function(data) {
               notificationModal("success",pageLang(1992),pageLang(1993))
               userRefresh()
            }
            });
