      ...
      $('<article class="PageArea">\
         ...
         <div class="row">\
            <div class="col-12 pageTitle">\
               ...
               <div class="Right">\
                  <div class="Btn" onclick="popAdd()"> '+pageLang(2402)+' </div>\
               </div>\
            </div>\
            <div class="col-12 ">\
         ...
         success: function(data) {
            ...
            $.each( data, function( i, itemx ) {
               ...
               <tr departmentId="'+data_ID+'">\
                  ...
                  <td>\
                     <div class="BtnList">\
                        <div class="Btn"><a role="menuitem" tabindex="-1" onclick="popDelete('+data_ID+')">'+pageLang(2404)+'</a></div>\
                     </div>\
                  </td>\
               </tr>\
               ')
      ...
      function popAdd(DATA_ID){
         ...
         <div class="col-md-4"> <label class="mg-b-0">'+pageLang(2405)+'</label> </div>\
         ...
         $('<div class="theme-button success-btn btnSuccess"><span class="iwo-293"></span> '+pageLang(2406)+' </div>\
         <div class="theme-button default-btn btnCancel"><span class="ifa-58"></span> '+pageLang(2407)+'</div>\
         ...
         $(".Popup_v2.B"+BOX+">.Modal>.Htm>.Document>.Bottom>.column.Right>.btnSuccess").click(function(){
            ...
            if(Error==0){
               ...
               $.ajax({
               type: "post",
               url: systemApp+"library/avatarAdd",
               dataType: "json",
               ...
               success: function(data) {
                  ...
                  notificationModal(data.status,pageLang(2408),data.message)
               },error: function() {
                  $(".Popup_v2.B"+BOX+"").removeClass("Loading")
                  notificationModal("error",pageLang(2408),pageLang(2409))
               }
               });
            }
         });
      ...
      function popDelete(DATA_ID){
         var WIDTH      =  "center-30"
         var BOX 		   =	1
         var TITLE 		=	pageLang(2404)
         var SUBTITLE	=	pageLang(2410)
         var nonTITLE   =  1
         var nonCLOSE   =  1
         popupTrigger(BOX,WIDTH,TITLE,SUBTITLE,nonTITLE,nonCLOSE)
         ...
         $(".Popup_v2.B"+BOX+">.Modal>.Htm>.Document>.Bottom>.column.Right>.btnSuccess").click(function(){
               ...
               $.ajax({
               type: "post",
               url: systemApp+"library/avatarDelete",
               dataType: "json",
